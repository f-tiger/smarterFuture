...
并包含 businessModel、competitors[]、analysis、roadshow、claudeReplicability、landingPlan，以及完整的 marketing 块
（personas/positioning/valueProp/funnelAARRR/channels[含estCacUsd,estConversion,automation]/contentEngine/growthLoops/kpis/monthlyBudgetUsd/automationPlaybook），
营销侧务必标注哪些渠道与任务可全自动(ai-auto)、哪些需人工(ai-human/human)，字段命名与下例完全一致）：
...
const EXAMPLE = `[{
 ...
 "marketing":{
   "personas":[{"name":"...","profile":"...","painPoint":"...","whereToFind":"..."}],
   "positioning":"...","valueProp":"...",
   "funnelAARRR":{"acquisition":"...","activation":"...","retention":"...","referral":"...","revenue":"..."},
   "channels":[{"channel":"SEO","tactic":"...","estCacUsd":2,"estConversion":"2%","automation":"ai-auto","priority":"high"}],
   "contentEngine":{"pillars":["..."],"cadence":"每周5篇","formats":["博客","短视频"],"autoGenerated":true},
   "growthLoops":["..."],"kpis":[{"name":"MRR","target":"$5k/月"}],"monthlyBudgetUsd":200,
   "automationPlaybook":[{"task":"SEO文章批量生成","tool":"Claude+脚本","owner":"claude","frequency":"每日"},{"task":"广告创意A/B","tool":"Claude","owner":"ai-human","frequency":"每周"}]
 }
}]`;
